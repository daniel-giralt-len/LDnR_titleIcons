...
const chapters = [
  ...
  { name: n.WHEN_THE_YOGURT_TOOK_OVER, icons: [i.CLOUDMOON, i.PLANTPOT, i.STRAWBERRY]},
...
const getIconsFromChapter = chapter => chapters.find(({name}) => name.toLowerCase() === chapter.toLowerCase())
